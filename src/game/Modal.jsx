    ...
    return (
        <div>
            ...
            <div className={styles.centerLine}>
                ...
                <input type='number' value={width} onChange={(e) => setWidth(e.target.value)} className={styles.gridDims} placeholder="Width" />
                <input type='number' value={height} onChange={(e) => setHeight(e.target.value)} className={styles.gridDims} placeholder="Height" />
                <div>
